import ButtonInteraction from "../ButtonInteraction.jsx/ButtonInteraction";
...
function MaterialItem(props) {
    console.log('%cmy-react-app/src/components/MaterialItem/MaterialItem.jsx:8 dictionary', 'color: #007acc;', dictionary);
